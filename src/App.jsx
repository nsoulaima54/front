...
const activeAlertsCount = alerts.filter(
  ...
  // Outside of JSX, in your component body:
const moduleCharts = {
  DRILL001: [
    "http://localhost:3000/d-solo/null?orgId=1&from=1759946339088&to=1759946639088&timezone=browser&var-query0=&var-DigitalModule=DRILL001&var-query0-2=&editIndex=1&var-Sensor=drill_vibration1&theme=light&panelId=panel-2&__feature.dashboardSceneSolo=true",
    "http://localhost:3000/d-solo/null?orgId=1&from=1759946339088&to=1759946639088&timezone=browser&var-query0=&var-DigitalModule=DRILL001&var-query0-2=&editIndex=1&var-Sensor=drill_pressure1&theme=light&panelId=panel-3&__feature.dashboardSceneSolo=true",
    "http://localhost:3000/d-solo/null?orgId=1&from=1759946339088&to=1759946639088&timezone=browser&var-query0=&var-DigitalModule=AIQS001&var-query0-2=&editIndex=1&var-Sensor=aiqs_camera1&theme=light&panelId=panel-2&__feature.dashboardSceneSolo=true"
  ],
  MILL001: [
    "http://localhost:3000/d-solo/null?orgId=1&from=1759946339088&to=1759946639088&timezone=browser&var-query0=&var-DigitalModule=AIQS001&var-query0-2=&editIndex=1&var-Sensor=aiqs_temp1&theme=light&panelId=panel-2&__feature.dashboardSceneSolo=true",
    "http://localhost:3000/d-solo/null?orgId=1&from=1759946339088&to=1759946639088&timezone=browser&var-query0=&var-DigitalModule=DRILL001&var-query0-2=&editIndex=1&var-Sensor=drill_temp1&theme=light&panelId=panel-2&__feature.dashboardSceneSolo=true",
    "http://localhost:3000/d-solo/null?orgId=1&from=1759946339088&to=1759946639088&timezone=browser&var-query0=&var-DigitalModule=AIQS001&var-query0-2=&editIndex=1&var-Sensor=aiqs_temp1&theme=light&panelId=panel-2&__feature.dashboardSceneSolo=true"
  ],
  AIQS001: [
    "http://localhost:3000/d-solo/null?orgId=1&from=1759946339088&to=1759946639088&timezone=browser&var-query0=&var-DigitalModule=MILL001&var-query0-2=&editIndex=1&var-Sensor=mill_temp1&theme=light&panelId=panel-2&__feature.dashboardSceneSolo=true",
    "http://localhost:3000/d-solo/null?orgId=1&from=1759946339088&to=1759946639088&timezone=browser&var-query0=&var-DigitalModule=MILL001&var-query0-2=&editIndex=1&var-Sensor=mill_vibration1&theme=light&panelId=panel-2&__feature.dashboardSceneSolo=true",
    "http://localhost:3000/d-solo/null?orgId=1&from=1759946339088&to=1759946639088&timezone=browser&var-query0=&var-DigitalModule=MILL001&var-query0-2=&editIndex=1&var-Sensor=mill_spindle_speed1&theme=light&panelId=panel-3&__feature.dashboardSceneSolo=true"
  ]
};
...
{/* === 🧩 Combined Row for Threshold + Visualization === */}
<div className="row g-4 mb-4">
  {/* === ⚙️ Sensor Threshold Management (3/4 width, left) === */}
  ...
  {/* === 🧠 Sensor Visualization (1/4 width, right) === */}
      ...
      <div className="card-body">
        <div className="d-flex flex-column gap-3">
          {['DRILL001', 'MILL001', 'AIQS001'].map((module) => (
            <button
              key={module}
              className={`btn btn-lg w-100 rounded-4 fw-semibold shadow-sm ${
...
{showModuleCharts && selectedModule && (
  <div
    ...
    onClick={() => setShowModuleCharts(false)}
  >
    <div
    ...
    >
      <div className={`modal-content ${darkMode ? 'bg-dark text-light' : 'bg-light text-dark'}`}>
        ...
        <div className="modal-body">
          {/* Styled description */}
          <div
            className={`p-3 mb-4 rounded-4 shadow-sm ${
              darkMode ? 'bg-secondary text-light' : 'bg-light text-dark'
            }`}
          >
            {selectedModule === 'DRILL001' && 'This module monitors drill temperature, pressure, and vibration.'}
            {selectedModule === 'MILL001' && 'This module monitors mill temperature, pressure, and vibration.'}
            {selectedModule === 'AIQS001' && 'This module monitors AIQS temperature, pressure, and vibration.'}
          </div>

          {/* Charts Grid */}
          <div className="row g-4">
            {moduleCharts[selectedModule].map((url, index) => (
              <div key={index} className="col-12 col-md-6 col-lg-4">
                <div className="card rounded-4 shadow-sm overflow-hidden border-0 h-100">
